# modified from
# https://github.com/sgosline/pnfCellLines/blob/4009ddc118eb537dd60855996d39796ed448d713/bin/segmentCNVData.R
...
synStore(sf,used=list(list(name='segmentCNVData.R',
                           url='https://raw.githubusercontent.com/Sage-Bionetworks/NTAP/master/pnfCellLines/analysis/segmentCNVData.R',wasExecuted=TRUE),
                      list(entity='syn5005069',wasExecuted=FALSE),
                      list(name='CNVData.R',
                           url='https://raw.githubusercontent.com/Sage-Bionetworks/NTAP/master/pnfCellLines/dataAccess/CNVData.R',wasExecuted=TRUE)),
